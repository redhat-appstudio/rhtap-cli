...
The product name, `.name` attribute, is converted sanitized to work as a template variable. For example, if the product name is `Developer Hub` it will be converted to `Developer_Hub`.
