...
The attributes of the `cli` object are as follows:
...
- `.products`: Defines the products to be deployed by the installer. Each product is identified by a unique name and a set of properties.
