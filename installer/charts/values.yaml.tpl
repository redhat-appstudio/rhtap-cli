...
{{- $acs := required "Red Hat ACS settings" .Installer.Products.redHatAdvancedClusterSecurity -}}
...
{{- $quay := required "Quay settings" .Installer.Products.redHatQuay -}}
{{- $rhdh := required "RHDH settings" .Installer.Products.redHatDeveloperHub -}}
