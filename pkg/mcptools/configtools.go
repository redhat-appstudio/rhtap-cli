...
// ConfigTools represents a set of tools for manaing the TSSC configuration in a
...
func (c *ConfigTools) getHandler(
	...
	// The error indicates the cluster a different issue than the absence of
	// configuration, showing the user the error.
